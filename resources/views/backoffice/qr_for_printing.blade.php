...
<head>
    ...
    <style>
        ...
        @media print {
            .normal-content {
                display: none; /* Hide normal content when printing */
            }
            .print-content {
                display: block; /* Show print-specific content when printing */
            }
        }
    </style>
</head>
<body class="w-full h-screen overflow-hidden bg-[#f2f2f2]">
    <div class="w-full flex items-center h-[7%] bg-[#db121c] px-10 normal-content">
    ...
    <div class="w-full h-[93%] flex">
        ...
        <div class="w-[95%] p-7 h-screen overflow-hidden print-content">
            <div class="w-full h-full flex items-center justify-center">
                <div class="bg-slate-200 p-2">
                    {{QrCode::size(256)->generate($item.','.$retail);}}
                    <p class="text-center text-2xl font-semibold">{{$item}}</p>
                </div>
            </div>
        </div>
    </div>
